...
import com.game24h.vietlottery.entity.Mega645Previous;
...
public class Mega645CurrentAsync extends AsyncTask<String, Void, Mega645Current> {
    private static final String NAME_MEGA645_CURRENT = "Current_mega645";
    ...
    public Mega645CurrentAsync(Context context, Mega645AsyncCallback callback) {
    ...
    protected Mega645Current doInBackground(String... strings) {
        ...
        try {
            ...
            readWriteJsonFileUtils.createJsonFileData(NAME_MEGA645_CURRENT, new Gson().toJson(mega645Current));
            return mega645Current;
        } catch (Exception e) {
            e.printStackTrace();
            mega645Current = new Gson().fromJson(readWriteJsonFileUtils.readJsonFileData(NAME_MEGA645_CURRENT), Mega645Current.class);
            return mega645Current;
        }
    }
